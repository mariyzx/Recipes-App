...
import whiteHeartIcon from '../images/heart.png';
  ...
  return (
    <section>
      { recipe.map((item, index) => (
        <div className="div-foods-drinks " key={ index }>
          <div className="div-details">
            ...
            />
            <h4 className="steps"> Ingredients </h4>
            { measures.map((_, i) => (
              <p
                className={ `ingredient-${i}` }
                key={ i }
            ...
            <p className="inst" data-testid="instructions">{item.strInstructions}</p>
            <iframe
              width="1280"
              data-testid="video"
              height="720"
              ...
              history.location.pathname.includes('drinks') && foods.foods)) ? (
                drinks.drinks.slice(0, num6).map((drink, id) => (
                  <div key={ id } data-testid={ `${id}-recomendation-card` }>
                    <p className="rec" data-testid={ `${id}-recomendation-title` }>
                      {drink.strDrink}
                    </p>
                    <img
